...
class EggApplication extends EggCore {
    ...
    constructor(options = {}) {
        ...
        // 对于application 和 agent都会调用，这个是在xx_loader里面定义的
        ...
        this.ready(() => {
            ...
            this.logger.warn('[egg:logger] test print in %s.', this.options.type)
        });
        this._setupTimeoutTimer();

        this.console.info('[egg:core111] App root: %s', this.baseDir);
        this.console.info('[egg:core222] All *.log files save on %j', this.config.logger.dir);
        //this.console.info('[egg:core333] Loaded enabled plugin %j', this.loader.orderPlugins);
    ...
    createContext(req, res) {
        ...
        // 去掉了 context.state = {} 属性，在koa里面是有的
